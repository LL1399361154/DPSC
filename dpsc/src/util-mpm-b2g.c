...
void B2gThreadInitCtx(MpmCtx *, MpmThreadCtx *);
void B2gDestroyCtx(MpmCtx *);
void B2gDestroyThreadCtx(MpmCtx *, MpmThreadCtx *);
...
uint32_t B2gSearchWrap(MpmCtx *mpm_ctx, MpmThreadCtx *mpm_thread_ctx, PrefilterRuleStore *, uint8_t *buf, uint16_t buflen);
uint32_t B2gSearch1(MpmCtx *mpm_ctx, MpmThreadCtx *mpm_thread_ctx, PrefilterRuleStore *, uint8_t *buf, uint16_t buflen);
#ifdef B2G_SEARCH2
uint32_t B2gSearch2(MpmCtx *mpm_ctx, MpmThreadCtx *mpm_thread_ctx, PrefilterRuleStore *, uint8_t *buf, uint16_t buflen);
#endif
uint32_t B2gSearch(MpmCtx *mpm_ctx, MpmThreadCtx *mpm_thread_ctx, PrefilterRuleStore *, uint8_t *buf, uint16_t buflen);
uint32_t B2gSearchBNDMq(MpmCtx *mpm_ctx, MpmThreadCtx *mpm_thread_ctx, PrefilterRuleStore *pmq, uint8_t *buf, uint16_t buflen);
...
void MpmB2gRegister (void)
{
    ...
    mpm_table[MPM_B2G].DestroyThreadCtx = B2gDestroyThreadCtx;
...
void B2gThreadInitCtx(MpmCtx *mpm_ctx, MpmThreadCtx *mpm_thread_ctx)
{
...
void B2gDestroyThreadCtx(MpmCtx *mpm_ctx, MpmThreadCtx *mpm_thread_ctx)
{
...
uint32_t B2gSearchWrap(MpmCtx *mpm_ctx, MpmThreadCtx *mpm_thread_ctx, PrefilterRuleStore *pmq, uint8_t *buf, uint16_t buflen)
{
    B2gCtx *ctx = (B2gCtx *)mpm_ctx->ctx;
...
uint32_t B2gSearch(MpmCtx *mpm_ctx, MpmThreadCtx *mpm_thread_ctx, PrefilterRuleStore *pmq, uint8_t *buf, uint16_t buflen)
{
    B2gCtx *ctx = (B2gCtx *)mpm_ctx->ctx;
#ifdef B2G_COUNTERS
    B2gThreadCtx *tctx = (B2gThreadCtx *)mpm_thread_ctx->ctx;
...
#ifdef B2G_SEARCH2
uint32_t B2gSearch2(MpmCtx *mpm_ctx, MpmThreadCtx *mpm_thread_ctx, PrefilterRuleStore *pmq, uint8_t *buf, uint16_t buflen)
{
    B2gCtx *ctx = (B2gCtx *)mpm_ctx->ctx;
    uint8_t *bufmin = buf;
...
uint32_t B2gSearch1(MpmCtx *mpm_ctx, MpmThreadCtx *mpm_thread_ctx, PrefilterRuleStore *pmq, uint8_t *buf, uint16_t buflen)
{
    SCEnter();
...
static int B2gTestSearch01 (void)
{
    ...
    B2gDestroyThreadCtx(&mpm_ctx, &mpm_thread_ctx);
    B2gDestroyCtx(&mpm_ctx);
    return result;
}
